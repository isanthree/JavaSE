...
public class ReflectionTest {
	...
	public void test2() throws Exception {
		...
		Person p = (Person) obj;  // 如果使用泛型，就不需要强转
		...
		// 通过反射，可以调用 Person 类的「私有结构」的。比如：私有的构造器、方法、属性
		// 调用私有的构造器
	 ...
	 *     此过程就称为类的加载。加载到内存中的类，我们就称为「运行时类」，此运行时类，就作为 Class 的一个实例。
	 *
	...
	public void test3() throws ClassNotFoundException {
		...
		// *方式三：调用 Class 的静态方法：forName(String classPath) ———— 常用
		Class clazz3 = Class.forName("com.isanthree.reflection.Person");
//        clazz3 = Class.forName("java.lang.String");
		...
		// 方式四：使用类的加载器：ClassLoader（了解即可）———— 不常用
		ClassLoader classLoader = ReflectionTest.class.getClassLoader();
		Class clazz4 = classLoader.loadClass("com.isanthree.reflection.Person");
