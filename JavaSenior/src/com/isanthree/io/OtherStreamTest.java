...
public class OtherStreamTest {
	...
	public void test2() {
		PrintStream ps = null;
		try {
			FileOutputStream fos = new FileOutputStream(new File("dataDir\\text.txt"));
	...
	public void test3() throws IOException {
		// 1. 造文件、造流
		DataOutputStream dos = new DataOutputStream(new FileOutputStream("dataDir\\data.txt"));
		// 2. 写操作
		dos.writeUTF("hhh");
	...
	public void test4() throws IOException {
		// 1.
		DataInputStream dis = new DataInputStream(new FileInputStream("dataDir\\data.txt"));
		// 2.
