package com.isanthree.common_classes.comparator;
...
public class CompareTest {
	 ...
	 * 1.像 String，包装类实现了Comparable 接口，重写了 compareTo(obj) 方法，给出了比较两个对象大小的方式。
	 * 2.像 String，包装类重写了 compareTo() 方法以后，进行从小到大的排列
